...
$scope.candidatos = [
    {nombre: 'Otto Guevara', 
     partido:'ML', 
     partidoL:'Movimiento Libertario',
        partidoFlag:'img/mlflag.png',
     imagen:'img/ml.png',
     coincidencia: '90%',
     color1: 'rgba(240, 128, 128, 0.40)',
     color2: 'lightcoral'
      },

     {
      nombre: 'Otton Solis', 
      partido:'PAC', 
      partidoL:'Partido Accion Ciudadana',
         partidoFlag:'img/pacflag.gif',
      imagen:'img/pac.jpg',
      coincidencia: '70%',
      color1: 'rgba(255, 160, 122, 0.40)',
      color2: 'lightsalmon'
      },

          {nombre: 'Juan Diego Castro', 
     partido:'PIN', 
     partidoL:'Partido Integracion Nacional',
      partidoFlag:'img/pinflag.png',
       imagen:'img/pin.jpg',
       coincidencia: '50%',
             color1: 'rgba(176, 196, 222, 0.40)',
      color2: 'lightsteelblue'
      },

          {nombre: 'Jose Maria Villalta', 
     partido:'FA', 
     partidoL:'Frente Amplio',
      partidoFlag:'img/faflag.jpg',
       imagen:'img/fa.jpg',
       coincidencia: '40%',
                    color1: 'rgba(255, 201, 0, 0.4)',
      color2: '#ffc900'
      },

          {nombre: 'Antonio Alvarez', 
     partido:'PLN', 
     partidoL:'Partido Liberacion Nacional',
          partidoFlag:'img/plnflag.png',
       imagen:'img/pln.jpg',
       coincidencia: '30%',
                           color1: 'rgba(50, 205, 50, 0.40)',
      color2: 'limegreen'
      },
  ...
  var cardTypes = [
    { image: 'img/tema_gay.jpeg',
      tema: 'Matrimonio Igualitario' },
    { image: 'img/tema_mineria.jpg',
    tema: 'Explotacion Minera' },
        { image: 'img/tema_carcel.jpg',
        tema: 'Beneficios carcelarios' }
